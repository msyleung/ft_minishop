...
if ($_SESSION["admin_msg"]) {
	echo $_SESSION["admin_msg"]."<br>";
	$_SESSION["admin_msg"] = "";
}
?>
			<div class="description-box">Categories</div>
				<div class="display-container" id="change">
					<div class="categories" id="cat-display1"><a href="cat_food.php">Cat Food</a></div>
					<div class="categories" id="cat-display2"><a href="cat_toys.php">Toys</a></div>
					<div class="categories" id="cat-display3"><a href="furniture.php">Furniture</a></div>
					<div class="categories" id="cat-display4"><a href="utilities.php">Utilities</a></div>
				</div>
		</div>
		<div class="grid-flex">
			<div class="description-box">Featured Items</div>
